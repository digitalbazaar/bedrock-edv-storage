...
// FIXME: remove usage of this middleware
...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  // FIXME: remove these two routes
  routes.authorizations = `/edvs/:edvId/authorizations`,
  routes.zcaps = `/edvs/:edvId/zcaps`;
...
function _authorizeZcapInvocation({
  ...
  return authorizeZcapInvocation({
    ...
    getRootController,
    // FIXME:
    documentLoader() {throw new Error('not implemented')},
    // documentLoader,
    getExpectedTarget,
    expectedAction,
    logger,
