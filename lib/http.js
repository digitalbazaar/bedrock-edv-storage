...
logger.info(`get chunk ${docId} chunkIndex ${chunkIndex}`);
      try {
        chunkIndex = parseInt(chunkIndex, 10);
      } catch(e) {
logger.error(`ERROR chunk ${docId} chunkIndex ${chunkIndex}`, {error: e});
...
logger.info(`got chunk ${docId} chunkIndex ${chunkIndex}`, {chunk});
      // TODO: need to determine how to filter the recipients to include
      // in the JWE (use specified recipient key in the JWE or invoker ID
      // somehow)
