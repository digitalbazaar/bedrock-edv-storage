...
// minimum document compatibility version; maximum value is `1`, minimum is
// `0`; if set to `1` then deployments with this configuration will be
// incompatible with deployments using version `0`; documents will still be
// automatically upgraded to work with the latest version (`1`), but will
// continue to work with version `0` until this config value is set to `1`
cfg.documentCompatibilityVersion = 0;
