 ...
 *
 * @return {Promise | ExplainObject} Resolves once the operation completes or
 ...
 * @param {boolean} [options.explain=false] - An optional explain boolean.
 *
 * @return {Promise<Object> | ExplainObject} resolves to `{chunk, meta}` or
 *   returns an ExplainObject if `explain=true`.
 */
 ...
 * @param {boolean} [options.explain=false] - An optional explain boolean.
 *
 * @return {Promise<Boolean> | ExplainObject} resolves to `true` if a document
 *   chunk was removed and `false` if not or returns an ExplainObject if
 *   `explain=true`.
 */
